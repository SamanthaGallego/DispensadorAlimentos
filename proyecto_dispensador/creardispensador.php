...
<body>
    ...
    if(isset($_POST["enviar"])){
        ...
        $ac = $_POST["alto_cabina"];
        $user = $_POST["user_name"];
        $e = $_POST["estado"];


        $url_rest = "http://localhost:3000/dispensador";
        $data = array(
            "id_dispensador" => $id_d,
            "alto_cabina" => $ac,
            "user_name"=>$user,
      ...
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="card cascading-right" style="
          ...
          <div class="card-body p-5 shadow-5 text-center">
            <h2 class="fw-bold mb-5">Crear Dispensador</h2>
            <form action="creardispensador.php" method="post">

              <div class="form-outline mb-4">
                <input type="double" name="alto_cabina" class="form-control" />
                <label class="form-label" for="form3Example3">Alto cabina</label>
              </div>
