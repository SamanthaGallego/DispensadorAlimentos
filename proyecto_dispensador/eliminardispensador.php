...
<body>
    ...
    $url_rest_get = "http://localhost:3000/dispensador/";
    ...
    if ($_GET) {
        ...
        $id = $_GET['id_dispensador'];

        $url_rest_del = "http://localhost:3000/dispensador/$id";
        ...
        header("Location: eliminardispensador.php");

    }

    ?>

    <form action="eliminardispensador.php" method="post">
            ...
            <tbody>
                <tr>
                    ...
                    for ($i = 0; $i <= $tam_get - 1; $i++) {
                        ...
                        echo "</td>";
                        echo "<td>";
                        echo "<a href=\"?id_dispensador=" . $id_dis . "\">Borrrar</a>";
                        echo "</td>";
                        echo "</tr>";
