...
<body>
    ...
    if(isset($_POST["enviar"])){
        ...
        $id_d = $_POST["id_dispensador"];
        $na = $_POST["nivel_alimento"];
        $a = $_POST["alerta"];
        $f = $_POST["fecha"];
      ...
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="card cascading-right" style="
          ...
          <div class="card-body p-5 shadow-5 text-center">
            <h2 class="fw-bold mb-5">Crear Datos</h2>
            <form action="creardatos.php" method="post">
              
              <!-- Password input -->
              <div class="form-outline mb-4">
                <input type="int" name="id_dispensador" class="form-control" />
                <label class="form-label" for="form3Example4">Id dispensador</label>
              </div>

              <div class="form-outline mb-4">
                <input type="double" name="nivel_alimento" class="form-control" />
                <label class="form-label" for="form3Example3">Nivel Alimento</label>
              </div>

              <div class="form-outline mb-4">
                <input type="text" name="alerta" class="form-control" />
                <label class="form-label" for="form3Example3">Alertas</label>
              </div>
              <div class="form-outline mb-4">
