...
<body>
    ...
    $url_rest_get = "http://localhost:3000/alertas/";
    ...
    if ($_GET) {
        ...
        $url_rest_del = "http://localhost:3000/alertas/$id";
        ...
        header("Location: eliminaralertas.php");

    }

    ?>

    <form action="eliminaralertas.php" method="post">
            ...
            <tbody>
                <tr>
                    ...
                    for ($i = 0; $i <= $tam_get - 1; $i++) {
                        $result = $resp_get[$i];
                        $id_al = $result->id_alertas;
                        $an = $result->alertanivel;
                        $est = $result->estado;
                        ...
                        echo "</td>";
                        echo "<td>";
                        echo "<a href=\"?id_alertas=" . $id_al . "\">Borrrar</a>";
                        echo "</td>";
                        echo "</tr>";
